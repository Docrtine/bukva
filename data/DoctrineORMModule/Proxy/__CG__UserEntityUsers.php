...
class Users extends \User\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'id', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'name', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'secondName', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'User\\Entity\\Users' . "\0" . 'date');
        }
